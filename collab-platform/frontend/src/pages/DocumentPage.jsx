...
<div style={{ padding: 12, fontSize: 13, lineHeight: 1.6, whiteSpace: 'pre-wrap', color: 'var(--text-primary)', height: 200, minHeight: 100, maxHeight: 500, overflow: 'auto', resize: 'vertical', WebkitOverflowScrolling: 'touch', touchAction: 'pan-y', border: '1px solid var(--border)', borderRadius: 6 }}>{aiResult}</div>
